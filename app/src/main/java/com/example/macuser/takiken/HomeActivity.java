...
public class HomeActivity extends ActionBarActivity
    ...
    public void onNavigationDrawerItemSelected(int position) {
        ...
        if(position == 0) {// HOME
//            Intent intent = new Intent(HomeActivity.this, MapsActivity.class);// どのクラスを対象にするか
//            startActivity(intent);// 画面遷移
        }else if(position == 1) {// 問題解答
            Intent intent = new Intent(HomeActivity.this, ProblemAnswerActivity.class);// どのクラスを対象にするか
            startActivity(intent);// 画面遷移
