...
public class RandomQuizFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if (getArguments().getString("type").equals("1")) {// 四択問題の場合
            view = inflater.inflate(R.layout.fragment_random_quiz, container, false);
        ...
        if (getArguments().getString("type").equals("2")) {// 記述形式問題の場合
            ...
            Button decision = (Button) view.findViewById(R.id.rq_type2_button);
            decision.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    EditText getAnswer = (EditText) getActivity().findViewById(R.id.rq_type2_answer);
